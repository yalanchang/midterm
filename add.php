                                    ...
                                    <div class="content-area">
                                        <div class="inputs border rounded p-3 mb-3">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="file" name="myFile[]" accept=".png,.jpg,.jpeg" onchange="previewImages(this)">
                                            </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="content[]" class="form-control" rows="3" placeholder="請輸入商品描述"></textarea>
                                            </div>
                                            <div class="input-group">
                                                <span class="input-group-text">價錢</span>
                                                <input name="price[]" type="text" class="form-control" placeholder="請輸入商品價格">
                                            </div>
                                            <div class="input-group">
                                                <span class="input-group-text">數量</span>
                                                <input name="quantity[]" type="text" class="form-control" placeholder="請輸入商品數量">
                                            </div>
                                            <div class="input-group">
